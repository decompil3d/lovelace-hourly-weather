...
| `show_precipitation_amounts`     | bool                   | **Optional** | Whether to show the aggregated precipitation (rain) amount for each displayed label interval under the bar bar                                                                                                       | `false`             |
