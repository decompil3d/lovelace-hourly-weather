...
customElements.define('action-handler-hourly-weather', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-hourly-weather')) {
    return body.querySelector('action-handler-hourly-weather') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-hourly-weather');
