...
export function getWindBarbSVG(windSpeed: number): TemplateResult<2> {
  if (windSpeed <= 0) return WIND_BARB_0;
  else if (windSpeed < 1.0) return WIND_BARB_0;
  else if (windSpeed < 2.5) return WIND_BARB_2;
  else if (windSpeed < 5.0) return WIND_BARB_5;
  else if (windSpeed < 7.5) return WIND_BARB_10;
  else if (windSpeed < 10.0) return WIND_BARB_15;
  else if (windSpeed < 12.5) return WIND_BARB_20;
  else if (windSpeed < 15.0) return WIND_BARB_25;
  else if (windSpeed < 17.5) return WIND_BARB_30;
  else if (windSpeed < 20.0) return WIND_BARB_35;
  else if (windSpeed < 22.5) return WIND_BARB_40;
  else if (windSpeed < 25.0) return WIND_BARB_45;
  else if (windSpeed < 27.5) return WIND_BARB_50;
  else if (windSpeed < 30.0) return WIND_BARB_55;
  else if (windSpeed < 32.5) return WIND_BARB_60;
  else if (windSpeed < 35.0) return WIND_BARB_65;
  else if (windSpeed < 37.5) return WIND_BARB_70;
  else if (windSpeed < 40.0) return WIND_BARB_75;
  else if (windSpeed < 42.5) return WIND_BARB_80;
  else if (windSpeed < 45.0) return WIND_BARB_85;
  else if (windSpeed < 47.5) return WIND_BARB_90;
  else if (windSpeed < 50.0) return WIND_BARB_95;
  else if (windSpeed < 52.5) return WIND_BARB_100;
  else if (windSpeed < 55.0) return WIND_BARB_105;
  else if (windSpeed < 57.5) return WIND_BARB_110;
  else if (windSpeed < 60.0) return WIND_BARB_115;
  else if (windSpeed < 62.5) return WIND_BARB_120;
  else if (windSpeed < 65.0) return WIND_BARB_125;
  else if (windSpeed < 67.5) return WIND_BARB_130;
  else if (windSpeed < 70.0) return WIND_BARB_135;
  else if (windSpeed < 72.5) return WIND_BARB_140;
  else if (windSpeed < 75.0) return WIND_BARB_145;
  else if (windSpeed < 77.5) return WIND_BARB_150;
  else if (windSpeed < 80.0) return WIND_BARB_155;
  else if (windSpeed < 82.5) return WIND_BARB_160;
  else if (windSpeed < 85.0) return WIND_BARB_165;
  else if (windSpeed < 87.5) return WIND_BARB_170;
  else if (windSpeed < 90.0) return WIND_BARB_175;
  else if (windSpeed < 92.5) return WIND_BARB_180;
  else if (windSpeed < 95.0) return WIND_BARB_185;
  else if (windSpeed < 97.5) return WIND_BARB_190;
